...
├── profiling_utils.py                # GPU profiling utility helpers
├── llama_champions_v2.json           # Hall of Fame — best discovered configs
├── ea_h100_transformer_results.csv   # Full trial log (params, throughput, MFU)
├── results/
│   ├── baseline_results.json         # Baseline evaluation results
│   └── profile_trace.json            # Nsight Systems profiling trace
...
#          ea_h100_transformer_results.csv   (full trial log)
```
...
*[📄 Read the Full Report](https://raw.githubusercontent.com/SameerRajendra/Adaptive-GPU-Optimization-for-Deep-Learning-Workloads-Using-Evolutionary-Algorithms/main/Sameer_AAI_800_Final_Report.pdf)*
